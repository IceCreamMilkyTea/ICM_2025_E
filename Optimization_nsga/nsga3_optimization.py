...
# plt.grid()
# plt.tight_layout()
# plt.savefig(f"pareto_solutions_n_gen_{n_gen}.png")
# plt.show()
...
# plt.grid()
# plt.tight_layout()
# plt.savefig(f"pareto_decision_variables_n_gen_{n_gen}.png")
# plt.show()
...
class PesticideOptimizationProblem(ElementwiseProblem):
    def __init__(self):
        super().__init__(n_var=16, n_obj=2, n_constr=0, xl=0, xu=xu)
